...
interface EnhancedEventSelectorProps {
  events: Event[];
...
export const EnhancedEventSelector: React.FC<EnhancedEventSelectorProps> = ({
  events,
  selectedEvents,
  selectedSubEvents,
  onToggleEvent,
        ...
        {events.map((event) => {
          ...
          return (
            <div
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-gray-500">
                      {!event.isMultiDay && taskCount > 0 && (
                        <span>
                          {taskCount} task{taskCount !== 1 ? 's' : ''}
                        </span>
                      )}
                      {event.isMultiDay && subEventCount > 0 && (
                        <span>
              ...
              {isSelected && event.isMultiDay && event.subEvents && (
